...
const ContractorProfile = () => {
  const [name, setName] = useState("John Contractor");
  const [address, setAddress] = useState("456 Elm Street, City, State");
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.header}>Contractor Profile</Text>
